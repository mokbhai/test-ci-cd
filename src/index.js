const { log, handleError, formatTestResults } = require("./helpers");
const RegressionTestRunner = require("./test-runner");
...
const tester = new RegressionTestRunner(baseUrl, projectId, emails, port, localHost);
